<?php
// Ambil tingkat akses user dari session, jika tidak ada set default sebagai 'user'
...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    <a class="sidebar-brand d-flex align-items-center justify-content-center my-3" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3"><?= strtoupper($role_sekarang) ?></div>
    </a>
    <hr class="sidebar-divider my-0">
    
    <?php if ($role_sekarang === 'admin'): ?>
        <li class="nav-item <?= $curr == 'hero' ? 'active' : '' ?>"><a class="nav-link" href="?s=hero"><i class="fas fa-home"></i> <span>Beranda</span></a></li>
